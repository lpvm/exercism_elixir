...
defmodule RunLengthEncoderTest do
  ...
  @tag :pending
  test "decode string with one character repeated four times" do
    assert RunLengthEncoder.decode("4T") === "TTTT"
  end
  ...
  @tag :pending
  test "decode single characters repeated one hundred times" do
    assert RunLengthEncoder.decode("100W") ===
